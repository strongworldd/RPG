...
export class Menu {
    static startMenu(): Character[] {
        ...
        const monsters = [Vampire, Spectre, Golem, Chimere, Basilic];
        ...
        characterlist += `Entrez trois numéros séparés par des virgules (ex : 1,2,3) ou la lettre I pour accéder aux informations des aventuriers et des monstres\n`;
